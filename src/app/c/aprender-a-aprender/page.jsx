...
export async function generateMetadata({  }) {
  ...
  return {
    title: "Aprender a Aprender | HabilidadesCognitivas.com",
    description: "Neurociências e psicologia aplicadas à aprendizagem",
  };
}

const CoursePage = () => {
 
  const course = courses.find(course => course.url === "aprender-a-aprender");
