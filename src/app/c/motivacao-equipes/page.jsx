...
export async function generateMetadata({  }) {
  ...
  return {
    title: "Motivação de Equipes | HabilidadesCognitivas.com",
    description: "Neurociências e psicologia aplicadas à motivação",
  };
}

const CoursePage = () => {
 
  const course = courses.find(course => course.url === "motivacao-equipes");
